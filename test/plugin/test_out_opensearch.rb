  ...
  class TemplateIndexLifecycleManagementTest < self
    ...
    def test_template_create_with_rollover_index_and_default_ilm(data)
      ...
      stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/logstash").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/logstash").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash").
        with(basic_auth: ['john', 'doe']).
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/logstash").
        with(basic_auth: ['john', 'doe'],
             :body => "{\"aliases\":{\"logstash\":{\"is_write_index\":true}}}").
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//_xpack").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => '{"features":{"ilm":{"available":true,"enabled":true}}}', :headers => {"Content-Type"=> "application/json"})
      stub_request(:get, "https://logs.google.com:777/os//_ilm/policy/logstash-policy").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//_ilm/policy/logstash-policy").
        with(basic_auth: ['john', 'doe'],
    ...
    def test_template_create_with_rollover_index_and_default_ilm_on_logstash_format(data)
      ...
      stub_request(:head, "https://logs.google.com:777/os//").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # check if template exists
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash-#{date_str}").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      # creation
      stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/logstash-#{date_str}").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/logstash-#{date_str}").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash-#{date_str}").
        with(basic_auth: ['john', 'doe']).
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-log-#{date_str}-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})

      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-log-#{date_str}-000001%3E/#{alias_endpoint}/logstash-#{date_str}").
        with(basic_auth: ['john', 'doe'],
      ...
      assert_requested(:put, "https://logs.google.com:777/os//#{endpoint}/logstash-#{date_str}", times: 1)
    ...
    def test_template_create_with_rollover_index_and_default_ilm_with_empty_index_date_pattern(data)
      ...
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash").
        ...
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/myapp_deflector").
          with(basic_auth: ['john', 'doe'],
               body: "{\"settings\":{\"number_of_shards\":1,\"index.lifecycle.name\":\"logstash-policy\",\"index.lifecycle.rollover_alias\":\"logstash\"},\"mappings\":{\"type1\":{\"_source\":{\"enabled\":false},\"properties\":{\"host_name\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"created_at\":{\"type\":\"date\",\"format\":\"EEE MMM dd HH:mm:ss Z YYYY\"}}}},\"index_patterns\":\"logstash-*\",\"order\":51}").
          to_return(status: 200, body: "", headers: {})
      else
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-default-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-default-000001%3E/#{alias_endpoint}/logstash").
        with(basic_auth: ['john', 'doe'],
             :body => "{\"aliases\":{\"logstash\":{\"is_write_index\":true}}}").
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//_xpack").
    ...
    def test_template_create_with_rollover_index_and_custom_ilm(data)
      ...
      stub_request(:get, "https://logs.google.com:777/os//_xpack").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => '{"features":{"ilm":{"available":true,"enabled":true}}}', :headers => {"Content-Type"=> "application/json"})
      stub_request(:get, "https://logs.google.com:777/os//_ilm/policy/fluentd-policy").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//_ilm/policy/fluentd-policy").
        with(basic_auth: ['john', 'doe'],
    ...
    class TemplateCreateWithRolloverIndexAndILMPoliciesWithPlaceholdersTest < self
      ...
      def test_tag_placeholder_with_multiple_policies(data)
        ...
        stub_request(:get, "https://logs.google.com:777/os//_xpack").
          with(basic_auth: ['john', 'doe']).
          to_return(:status => 200, :body => '{"features":{"ilm":{"available":true,"enabled":true}}}', :headers => {"Content-Type"=> "application/json"})
        stub_request(:get, "https://logs.google.com:777/os//_ilm/policy/fluentd-policy2").
          with(basic_auth: ['john', 'doe']).
          to_return(:status => 404, :body => "", :headers => {})
        stub_request(:put, "https://logs.google.com:777/os//_ilm/policy/fluentd-policy2").
          with(basic_auth: ['john', 'doe'],
    ...
    def test_template_create_with_rollover_index_and_default_ilm_and_placeholders(data)
      ...
      stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/logstash").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/logstash-tag1").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash-tag1").
        with(basic_auth: ['john', 'doe']).
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/logstash-tag1").
          with(basic_auth: ['john', 'doe'],
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-tag1-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-tag1-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/logstash-tag1").
        with(basic_auth: ['john', 'doe'],
      ...
      stub_request(:put, "https://logs.google.com:777/os//_ilm/policy/logstash-policy").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/logstash-tag2").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/logstash-tag2").
        with(basic_auth: ['john', 'doe']).
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/logstash-tag2").
          with(basic_auth: ['john', 'doe'],
      ...
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-tag2-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//%3Clogstash-tag2-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/logstash-tag2").
        with(basic_auth: ['john', 'doe'],
    ...
    def test_template_create_with_rollover_index_and_default_ilm_and_custom_and_time_placeholders(data)
      ...
      stub_request(:head, "https://logs.google.com:777/os//").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # check if template exists
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/#{task_def_value}-#{date_str}").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      # creation
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/#{task_def_value}-#{date_str}").
          with(basic_auth: ['john', 'doe'],
      ...
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/#{task_def_value}-#{date_str}").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3C#{task_def_value}-#{date_str}-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      stub_request(:put, "https://logs.google.com:777/os//%3C#{task_def_value}-#{date_str}-default-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/#{task_def_value}-#{date_str}").
        with(basic_auth: ['john', 'doe'],
  ...
  class CustomTemplateIndexLifecycleManagementTest < self
    ...
    def test_custom_template_with_rollover_index_create_and_default_ilm(data)
      ...
      stub_request(:head, "https://logs.google.com:777/os//_alias/mylogs").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/mylogs").
        with(basic_auth: ['john', 'doe']).
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/mylogs").
          with(basic_auth: ['john', 'doe'],
      ...
      assert_requested(:put, "https://logs.google.com:777/os//#{endpoint}/mylogs", times: 1)
    end
    ...
    def test_custom_template_with_rollover_index_create_and_default_ilm_and_placeholders(data)
      ...
      stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/myapp_alias_template").
        ...
        to_return(:status => 200, :body => "", :headers => {})
      # creation of index which can rollover
      stub_request(:put, "https://logs.google.com:777/os//%3Cmylogs-test-tag1-myapp-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/mylogs-test-tag1").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/mylogs-test-tag1").
        with(basic_auth: ['john', 'doe']).
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/mylogs-test-tag1").
          with(basic_auth: ['john', 'doe'],
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Cmylogs-test-tag1-myapp-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/mylogs-test-tag1").
        with(basic_auth: ['john', 'doe'],
      ...
      # test-tag2
      # check if template exists
      stub_request(:get, "https://logs.google.com:777/os//_template/myapp_alias_template").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      # creation
      stub_request(:put, "https://logs.google.com:777/os//_template/myapp_alias_template").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      # creation of index which can rollover
      stub_request(:put, "https://logs.google.com:777/os//%3Cmylogs-test-tag2-myapp-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 200, :body => "", :headers => {})
      # check if alias exists
      stub_request(:head, "https://logs.google.com:777/os//_alias/mylogs-test-tag2").
        with(basic_auth: ['john', 'doe']).
        to_return(:status => 404, :body => "", :headers => {})
      stub_request(:get, "https://logs.google.com:777/os//#{endpoint}/mylogs-test-tag2").
        with(basic_auth: ['john', 'doe']).
        to_return(status: 404, body: "", headers: {})
      if use_legacy_template_flag
        stub_request(:put, "https://logs.google.com:777/os//#{endpoint}/mylogs-test-tag2").
          with(basic_auth: ['john', 'doe'],
      ...
      # put the alias for the index
      stub_request(:put, "https://logs.google.com:777/os//%3Cmylogs-test-tag2-myapp-%7Bnow%2Fw%7Bxxxx.ww%7D%7D-000001%3E/#{alias_endpoint}/mylogs-test-tag2").
        with(basic_auth: ['john', 'doe'],
